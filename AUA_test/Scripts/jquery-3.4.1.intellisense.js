...
intellisense.annotate(jQuery.fn, {
  ...
  'addClass': function() {
    ...
    ///   <param name="className" type="String">One or more space-separated Class to be added to the class attribute of each matched element.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Adds the specified class(es) to each of the set of matched elements.</summary>
  ...
  'class': function() {
    ...
    ///   <param name="class" type="String">A class to search for. An element can have multiple Class; only one of them must match.</param>
    /// </signature>
  },
  'clearQueue': function() {
    /// <signature>
  ...
  'removeClass': function() {
    /// <signature>
    ///   <summary>Remove a single class, multiple Class, or all Class from each element in the set of matched elements.</summary>
    ///   <param name="className" type="String">One or more space-separated Class to be removed from the class attribute of each matched element.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Remove a single class, multiple Class, or all Class from each element in the set of matched elements.</summary>
  ...
  'toggleClass': function() {
    /// <signature>
    ///   <summary>Add or remove one or more Class from each element in the set of matched elements, depending on either the class's presence or the value of the switch argument.</summary>

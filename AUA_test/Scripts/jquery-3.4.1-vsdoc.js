...
(function (window, undefined) {
    ...
    jQuery.prototype.addClass = function (value) {
        ...
        ///     One or more space-separated Class to be added to the class attribute of each matched element.
        /// </param>
        /// <returns type="jQuery" />

        var Class, elem, cur, clazz, j,
			i = 0,
			len = this.length,
        ...
        if (proceed) {
            ...
            Class = (value || "").match(core_rnotwhite) || [];
    ...
    jQuery.prototype.removeClass = function (value) {
        /// <summary>
        ///     Remove a single class, multiple Class, or all Class from each element in the set of matched elements.
        ///     &#10;1 - removeClass(className) 
        ///     &#10;2 - removeClass(function(index, class))
        /// </summary>
        /// <param name="value" type="String">
        ///     One or more space-separated Class to be removed from the class attribute of each matched element.
        /// </param>
        /// <returns type="jQuery" />
    ...
    jQuery.prototype.toggleClass = function (value, stateVal) {
        /// <summary>
        ///     Add or remove one or more Class from each element in the set of matched elements, depending on either the class's presence or the value of the switch argument.
